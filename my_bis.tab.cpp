...
int yylex(void);      //объ€вили тут функцию из лексического анализатора, определение которой генерируетс€ из l файла
void yyerror(const char *);
//int for_main(void);
const char* for_er[5] = {"heve not ;", "net 2 ckobki","net 2 operada","lishnii posle predlogenia","net kluchevogo slova"};//массив дл€ видов ошибок
int line1;
int line2;
int line3;
int line4;
